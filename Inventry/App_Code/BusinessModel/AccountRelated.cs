...
{
    public string AddAccounts(string parent,string code,string aname,string type,int levels,string owner,string usercode,string status,string detailvalues,string addt,string addp,string conperson,string telephone,string mobile,string email,string webpage,string remarks)
    {
        ...
        //param[18] = new SqlParameter("Return", SqlDbType.Int);
    ...
    public int UpdateAccount(string parent, string code, string aname, string type, string levels, string owner, string usercode, string status, string detailvalues, string addt, string addp, string conperson, string telephone, string mobile, string email, string webpage, string remarks)
    {
        SqlParameter[] param = new SqlParameter[18];
        param[0] = new SqlParameter("@Parent", parent);
        param[1] = new SqlParameter("@Code", code);
        ...
        param[6] = new SqlParameter("@UserCode", usercode);
        param[7] = new SqlParameter("@Status", status);
        param[8] = new SqlParameter("@DetailValues", detailvalues);
        param[9] = new SqlParameter("@AddT", addt);
        param[10] = new SqlParameter("@AddP", addp);
        param[11] = new SqlParameter("@ConPerson", conperson);
        param[12] = new SqlParameter("@Telephone", telephone);
        ...
        param[17] = new SqlParameter("@IfErrorMsg", SqlDbType.NChar, 254);
        param[17].Direction = ParameterDirection.Output;
        return DataAccessLayer.ExecuteProc("AccountRelated", param);
        //if (status=="I")
        //{
        //    if (type == "A")
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedIA", param);
        //    }
        //    else
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedIG", param);
        //    }
        //}
        //else if (status == "E")
        //{
        //    if (type == "A")
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedEA", param);
        //    }
        //    else
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedEG", param);
        //    }
        //}
        //else if (status == "D")
        //{
        //    if (type == "A")
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedDA", param);
        //    }
        //    else
        //    {
        //        DataAccessLayer.ExecuteProc("AccountRelatedDG", param);
        //    }
        //}
    }
