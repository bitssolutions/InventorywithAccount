...
public partial class Inventory_SalesReturn : System.Web.UI.Page
{
    ...
    protected void btnAddDataTable_Click(object sender, EventArgs e)
    {
        ...
        string msg = entryobj.SalesReturnI(vnum, owner, edate, ucode, acode, extdisc, hasnote, paytype, note, TableInitial);
        lblMsg.Text = msg;
